...
These YAML files describe the Spacelift stack configuration for each environment.
Use them as a reference when creating stacks in the Spacelift UI or via the
Spacelift Terraform provider.

## Using the Spacelift Terraform provider
